...
* bcash.conf: contains configuration settings for bcashd or bcash-qt
* bcashd.pid: stores the process id of bcashd while running
...
* debug.log: contains debug information and general logging generated by bcashd or bcash-qt
