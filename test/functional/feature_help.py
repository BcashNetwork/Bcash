...
"""Verify that starting bcash with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bcash with -h for help text")
        ...
        self.log.info("Start bcash with -version for version information")
