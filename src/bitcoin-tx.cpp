...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s bcash-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bcash-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bcash transaction") + "\n" +
              "  bcash-tx [options] -create [commands]   " + _("Create hex-encoded bcash transaction") + "\n" +
              "\n";
