...
const char * const BITCOIN_CONF_FILENAME = "bcash.conf";
const char * const BITCOIN_PID_FILENAME = "bcashd.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Bcash";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Bcash";
#else
    // Unix
    return pathRet / ".bcash";
#endif
#endif
}
